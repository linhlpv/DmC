...
class BaseDiffusionSDE(DiffusionModel):
    ...
    def __init__(
        ...
        # print(f'nn_condition: {nn_condition}')
        super().__init__(
    ...
    def loss(self, x0, condition=None):
        ...
        # print(f"condition model: {self.model['condition']}")
        # print(f"condition: {condition}")
        condition = self.model["condition"](condition) if condition is not None else None
        # print(f'condition shape: {condition.shape}, condition: {condition}')
